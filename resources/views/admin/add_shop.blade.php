            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Add Shop</h4> </div>
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                            ...
                            <div class="table-responsive">
                                <form class="form-horizontal form-material" method="POST" action="{{route('admin.addshop')}}">
                                @csrf
                                <div class="form-group">
                                    <label class="col-md-12">Shop name</label>
                                    <div class="col-md-8">
                                        <input type="text" name="name" placeholder="shop name" class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Shop email</label>
                                    <div class="col-md-8">
                                        <input type="email" name="email" placeholder="email here...." class="form-control form-control-line" name="example-email" id="example-email"> </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="phone" placeholder="phone number..!" class="form-control form-control-line"> </div>
                                </div>
                                <div class="form-group">
