        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="/myfiles/{{$product->primary_image}}" alt="Image">
                        </div>
                      <!--   <div class="carousel-item">
                            <img class="w-100 h-100" src="/myfiles/{{$product->image2}}" alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="/myfiles/{{$product->image3}}" alt="Image">
                        </div>
                        <div class="carousel-item">
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <div class="d-flex mb-4" id="color">
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <div class="input-group quantity mr-3" style="width: 130px;">
                            ...
                            <input type="text" id="count" name="count" class="form-control bg-secondary border-0 text-center" value="1">
                            <div class="input-group-btn">
                        ...
                        <button class="btn btn-primary px-3" onclick="addcart({{$product->id}},{{$product->price}})"><i class="fa fa-shopping-cart mr-1"></i> Add To
                            Cart</button>
                    </div>
...
<script type="text/javascript">
    ...
    var count=$('#count').val();
      $.ajax({
          ...
          data: {_token:'{{ csrf_token() }}',type:'add_cart',id:id,count:count,price:price,color:color,size:size},
...
$('#plus').click(function () {
    ...
    var x = parseInt(currentVal) + parseInt(newVal)
    // alert(x);
     $('#count').val(x);
});
</script>
